...
public final class ARM32ReservedRegisters extends ReservedRegisters {
    ...
    public static final Register THREAD_REGISTER = ARM32Registers.r9;

    // r8 is the Heap Base register candidate
    public static final Register HEAP_BASE_REGISTER_CANDIDATE = ARM32Registers.r8;
    ...
    ARM32ReservedRegisters() {
        ...
        super(ARM32Registers.r13, THREAD_REGISTER, HEAP_BASE_REGISTER_CANDIDATE, null);
    }
}
